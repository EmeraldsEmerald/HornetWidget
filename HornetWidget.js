...
Game.ObjectsById[2].minigame.toolsById[0] ={
				...
				descFunc:function()
				{
					...
					if (Game.ObjectsById[2].minigame.convertTimes > 0) (Game.ObjectsById[2].minigame.convertTimes == 1 ? str+='<div>You have sacrificed your garden to the hornets <span style="color:white">' + Beautify(Game.ObjectsById[2].minigame.convertTimes) + '</span> time.</div>' : str+='<div>You have sacrificed your garden to the hornets <span style="color:white">' + Beautify(Game.ObjectsById[2].minigame.convertTimes) + '</span> times.</div>' )
